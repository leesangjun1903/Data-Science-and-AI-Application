# Optimization
> ## Learning Hyperparameter Tuning, Loss function(Cost function), Objective function optimization, Meta-Learning, Few-Shot Learning, Multi-task Learning, Domain Adaption, Metric Learning, PU-Learning(Positive-Unlabeled Learning), Curriculum Learning, Topos and stacks(Not verified)
